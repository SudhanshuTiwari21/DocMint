    ...
    <article className="mx-auto max-w-6xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <div className="mb-14 rounded-xl border-2 border-dashed border-slate-300 dark:border-slate-600 bg-slate-50 dark:bg-slate-800/50 px-8 py-12 text-center">
        ...
        <p className="mt-2 text-slate-600 dark:text-slate-400">
          Tool interface under development. Meanwhile use our{" "}
          <Link href="/tools/resize-image-to-100kb" className="font-medium text-slate-900 underline dark:text-slate-100">resize to 100KB</Link>{" "}
          for file size limits, or <Link href="/tools/crop-image" className="font-medium text-slate-900 underline dark:text-slate-100">crop image</Link> for dimensions.
        </p>
      </div>
